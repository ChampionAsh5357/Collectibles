...
package net.ashwork.mc.collectibles.data;

import net.ashwork.mc.collectibles.data.client.CollectiblesTranslationProvider;
...
public class CollectiblesData {
    ...
    public static void init(IEventBus modBus) {
        modBus.addListener(CollectiblesData::gatherData);
    }
    ...
    private static void gatherData(GatherDataEvent event) {
        ...
        addProvider(generator, output -> new PackMetadataGenerator(output)
                .add(PackMetadataSection.TYPE, new PackMetadataSection(
                        Component.literal(CollectiblesTranslationKeys.PACK_DESCRIPTION),
        ...
        if (event.includeClient()) {
            addProvider(generator, CollectiblesTranslationProvider::new);
        }
    }
